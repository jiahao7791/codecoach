            ...
            <div className="container">
                ...
                <div className="row row-content">
                    <div className="col-12 col-md-6">
                        <h2>Our Mission</h2>
                        <p>We aim to impart Computer Science knowledge to people because of how important it will become in the future.</p>
                        <p>Why <strong>Code Coach</strong>?  Simply because we offer affordable, personalised and convenient lessons taught by only the best in the industry.</p>
                    </div>
